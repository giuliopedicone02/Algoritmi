...
private:
    ...
    {
        return (node->getNodeLeft() != NULL && node->getNodeLeft()->getColor() == _color) || (node->getNodeRight() != NULL && node->getNodeRight()->getColor() == _color);
    }
...
public:
    ...
    {
        // s << *node << " ";
        s << "(" << *node << " " << printColorChar(node->getColor()) << ") ";
    }
    ...
    void preorder(Node<T> *ptr)
    {
        ...
        visit(ptr);
        preorder(ptr->getNodeLeft());
        preorder(ptr->getNodeRight());
    }
    ...
    void inorder(Node<T> *ptr)
    {
        ...
        inorder(ptr->getNodeLeft());
        visit(ptr);
        inorder(ptr->getNodeRight());
    }
    ...
    void postorder(Node<T> *ptr)
    {
        ...
        postorder(ptr->getNodeLeft());
        postorder(ptr->getNodeRight());
        visit(ptr);
    }
