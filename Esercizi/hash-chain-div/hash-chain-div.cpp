...
#include "divisionChainedHashTable.h"
...
int main()
{
    ...
    while (fileInput.good())
    {
        ...
        if (type == "int")
        {
            DivisionChainedHashTable<int> *hashTable_int = new DivisionChainedHashTable<int>(m);
        ...
        if (type == "double")
        {
            DivisionChainedHashTable<double> *hashTable_double = new DivisionChainedHashTable<double>(m);
        ...
        if (type == "char")
        {
            DivisionChainedHashTable<char> *hashTable_char = new DivisionChainedHashTable<char>(m);
        ...
        if (type == "bool")
        {
            DivisionChainedHashTable<bool> *hashTable_bool = new DivisionChainedHashTable<bool>(m);
